...
<?php include 'displayuser.php'; ?>
	<div>
		<form action="searchuser.php" method="POST" class="forms" onsubmit="return validate()">
			<h1 style="text-align: center;color:rgb(43, 41, 41);font-family:Verdana;"><u>Search User Data</u></h1><br><br>
			<div>
				<label>Email</label>
				<input type="text" id= "cid" name="cid" class="car" placeholder="Eg. amitnaik@gmail.com" autocomplete="off">
			</div>
			<br><br>
			<div>
