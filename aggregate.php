...
<header>
   <div class="pre-title" >
	...
	<?php
		...
		$q1="select car_name,count(car_name) as 'car_count' from cars group by car_name";
	    ...
	    if($r1)
	    {
	        ...
	        {
	            echo "<tr><td>".$info['car_name']."</td>";
	            echo "<td>".$info['car_count']."</td></tr>";
	        }
	    }
	    else
	    {
