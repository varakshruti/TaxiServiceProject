...
<?php include 'displaydata.php'; ?>
	<div>
		<form action="usersearch.php" method="POST" class="forms" onsubmit="return validate()">
			<h1 style="text-align: center;color:rgb(43, 41, 41);font-family:Verdana;"><u>Search Car Data</u></h1><br><br>
			<div>
				<label>Car ID</label>
