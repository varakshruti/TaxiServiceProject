...
<?php include 'displaydata.php'; ?>
	<div>
		<form action="delete.php" method="POST" class="forms" onsubmit="return validate()">
			<h1 style="text-align: center;color:rgb(43, 41, 41);font-family:Verdana;"><u>Delete Car Data</u></h1><br><br>
			<div>
				<label> Car ID</label>
				<input type="number" id= "cid" name="cid" class="car" placeholder="Eg. 1" autocomplete="off">
			</div>
			<br><br>
			<div>
