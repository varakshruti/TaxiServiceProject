...
<head>
   ...
   <script type="text/javascript">
	   function valid()
      {
         ...
         var plocation="";
         plocation=document.getElementById("ploc").value;
         var dtime="";
         dtime=document.getElementById("dtime").value;
         var dlocation="";
         dlocation=document.getElementById("dloc").value;
         var passenger="";
         passenger=document.getElementById("nop").value;
         var x=/^[0-9]$/;
...
<?php include 'displaydata.php';?>
	<div>
		<form action="bookcars.php" method="POST" class="forms" onsubmit="return valid()">
			<h1 style="text-align: center;color:rgb(43, 41, 41);font-family:Verdana;"><u>Add Booking Data</u></h1><br><br>
			<div>
				<label>Car ID</label>
